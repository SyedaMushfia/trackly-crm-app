  ...
  return (
    <div className="p-4 sm:p-6 max-w-5xl mx-auto space-y-4 sm:space-y-6">
      ...
      <div className="flex flex-col gap-3 sm:flex-row sm:items-start sm:justify-between">
        ...
        <div className="space-y-1 min-w-0">
          <div className="flex items-center gap-2 flex-wrap">
            <h1 className="text-xl sm:text-2xl font-semibold text-foreground leading-tight">{lead.name}</h1>
      ...
      <div className="flex flex-col gap-4 sm:gap-6 lg:grid lg:grid-cols-3">
        {/* Left / main col — info + tasks + notes */}
        ...
        {/* Right col — quick stats: horizontal scroll row on mobile, vertical on lg */}
        <div className="flex flex-row gap-3 overflow-x-auto pb-1 lg:flex-col lg:overflow-x-visible lg:pb-0 lg:space-y-0 lg:gap-0 lg:space-x-0">
          <div className="flex gap-3 lg:flex-col lg:gap-0 lg:space-y-4 min-w-max lg:min-w-0 w-full">
            {[
              ...
              <div key={label} className="bg-card border rounded-lg p-4 flex-shrink-0 min-w-[130px] lg:min-w-0 lg:flex-shrink">
